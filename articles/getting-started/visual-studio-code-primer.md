...
Из документации Joomla!: [Visual Studio Code](https://docs.joomla.org/Visual_Studio_Code), который также охватывает настройку других инструментов, например, CodeSniffer и PHPUnit.
